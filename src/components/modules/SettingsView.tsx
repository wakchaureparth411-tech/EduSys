...
export const SettingsView: React.FC = () => {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    updateSettings({
      ...
      schoolLogo: formFields.schoolLogo,
      address: formFields.address,
      email: formFields.email,
      phone: formFields.phone,
      theme: formFields.theme as 'light' | 'dark',
      language: formFields.language,
      notificationsEnabled: formFields.notificationsEnabled
    });
    
    // Apply theme
    const root = document.documentElement;
    if (formFields.theme === 'dark') {
          ...
          <GlassCard hoverEffect={false} className="p-6">
            <form onSubmit={handleSave} className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) => setFormFields({ ...formFields, theme: e.target.value as 'light' | 'dark' })}
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) => setFormFields({ ...formFields, language: e.target.value })}
                      className="w-full px-3 py-2 text-xs rounded-lg bg-black/5 dark:bg-white/5 border border-[var(--card-border)] text-zinc-700 dark:text-zinc-300 focus:outline-none"
                    >
                  ...
                  <div className="flex items-center pt-2">
                    <input
                      ...
                      onChange={() => setFormFields({ ...formFields, notificationsEnabled: !formFields.notificationsEnabled })}
              ...
              <div className="flex justify-end pt-3">
                <button
                  type="submit"
                  className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-gradient-to-r from-brand-primary to-brand-secondary text-white text-xs font-bold shadow hover:scale-[1.01] transition-all"
                >
